  ...
  return (
    <div className="wrap">
      <div className="number">
        {!next ? <One width={isMobile ? "16px" : "40px"} /> : <Check width={isMobile ? "16px" : "40px"} />}
        <Arrow width={isMobile ? "68px" : "172px"} />
        {!result ? (
          <Circle width={isMobile ? "16px" : "40px"} stroke={next ? "#3178FF" : "#B3B3B3"} fill={next ? "#3178FF" : "none"}>
            <path
          ...
          <Check width={isMobile ? "16px" : "40px"} />
        )}
        <Arrow width={isMobile ? "68px" : "172px"} />
        {!done ? (
          <Circle width={isMobile ? "16px" : "40px"} stroke={result ? "#3178FF" : "#B3B3B3"} fill={result ? "#3178FF" : "none"}>
            <path
